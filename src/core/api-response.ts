...
export class ValidationErrorResponse<T> extends ApiResponse {
  constructor(message: string, private errors: T) {
    super(StatusCode.FAILURE, ResponseStatus.UNPROCESSABLE_ENTITY, message);
  }

  send(res: Response): Response {
    return super.prepare<ValidationErrorResponse<T>>(res, this);
  }
}
